...
export default function Inspector({ item, onChange }: Props) {
  if (!item) {
    return (
      <aside className="w-64 shrink-0 border-l border-slate-200/80 bg-white p-4">
  ...
  return (
    <aside className="w-64 shrink-0 border-l border-slate-200/80 bg-white p-4 overflow-auto">
      <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Inspector</div>
